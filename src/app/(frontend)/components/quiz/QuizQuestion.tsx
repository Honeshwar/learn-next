...
const LazySubmitModal = dynamic(() => import("./SubmitModal"), {
  ssr: false,
});
const LazyQuizHomeModal = dynamic(() => import("./QuizHomeModal"), {
  ssr: false,
});
...
export default function QuizQuestion({ lang = "hi" }: { lang: string }) {
  ...
  return (
    <>
      ...
      {openModal && (
        <LazyQuizHomeModal setOpenModal={setOpenModal} lang={lang} />
      )}
      {openSubmitModal && (
        <LazySubmitModal
